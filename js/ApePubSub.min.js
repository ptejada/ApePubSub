...
$this.isReady=true;if($this.reconnect>0){$this.reconnect=0;client.fireEvent("on_reconnected");}else{client.fireEvent("on_connected");}
APE.debug('Your client is now connected');callback();})
client.load({identifier:"PubSub",domain:"auto"});this.client=client;return this;}
