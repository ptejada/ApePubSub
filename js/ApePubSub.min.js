...
function APS(c,a,e){this.option={poll:25E3,debug:!1,session:!0,connectionArgs:{},server:c,transport:["ws","lp"],secure:!1,eventPush:!1,addFrequency:!0,autoUpdate:!0};this.identifier="APS";this.version="1.6.4";this.state=0;this._events={};this.user={};this.pipes={};this.channels={};this.eQueue={};if(a)this.on(a);if(e)for(var d in e)this.option[d]=e[d];"Microsoft Internet Explorer"==navigator.appName&&(this.log="undefined"==typeof window.console?function(){}:function(){if(!1!=this.option.debug){var b=
...
APS.prototype.connect=function(c){var a=this.option.server,e={onmessage:this.onMessage.bind(this),onerror:function(b){this.trigger("dead",[b]);this.transport.close()}.bind(this)};if(1==this.state)return this.log("Already Connected!");var d="CONNECT";c=this.option.connectionArgs=c||this.option.connectionArgs;var b=this.session.restore();this.session.saveFreq();if(!0==this.option.session)if("object"==typeof b)c=b,d="RESTORE";else{if(!1==this.trigger("connect"))return!1}else if(this.state=0,!1==this.trigger("connect"))return!1;
this.option.addFrequency&&(a=this.session.getFreq()+"."+a);this.transport?0==this.transport.state&&(this.transport=new APS.Transport(a,e,this)):this.transport=new APS.Transport(a,e,this);c.version=this.version;this.sendCmd(d,c);return this};APS.prototype.reconnect=function(){if(0<this.state&&0<this.transport.state)return this.log("Client already connected!");this.channels={};this.connect()};
...
h+"://"+c+'/?[{"cmd":"frame","params": {"origin":"'+a+'"}}]');"addEventListener"in window?(window.addEventListener("message",d.bind(this),0),f.addEventListener("load",b.bind(this),0)):window.attachEvent("onmessage",d.bind(this));this.send=function(b,a){0<this.state?(f.contentWindow.postMessage(b,h+"://"+c),this.state=2):this.stack.push(b);"function"==typeof a&&a()};this.close=function(){clearTimeout(e.poller);e.state=0}};
