...
function APS(a,c,e){this.option={poll:25E3,debug:!1,session:!0,connectionArgs:{},server:a,transport:["ws","lp"],secure:!1,eventPush:!1,addFrequency:!0,autoUpdate:!0};this.identifier="APS";this.version="1.5.8";this.state=0;this._events={};this.chl=0;this.user={};this.pipes={};this.channels={};this.eQueue={};if(c)this.on(c);if(e)for(var d in e)this.option[d]=e[d];"Microsoft Internet Explorer"==navigator.appName&&(this.log="undefined"==typeof window.console?function(){}:function(){if(!1!=this.option.debug){var b=
