...
function APS(a,c,e){this.option={poll:25E3,debug:!1,session:!0,connectionArgs:{},server:a,transport:["ws","lp"],secure:!1,eventPush:!1,addFrequency:!0,autoUpdate:!0};this.identifier="APS";this.version="1.6.1-dev";this.state=0;this._events={};this.chl=0;this.user={};this.pipes={};this.channels={};this.eQueue={};if(c)this.on(c);if(e)for(var d in e)this.option[d]=e[d];"Microsoft Internet Explorer"==navigator.appName&&(this.log="undefined"==typeof window.console?function(){}:function(){if(!1!=this.option.debug){var a=
...
return!0};APS.prototype.on=function(a,c){var e=[];if("string"==typeof a&&"function"==typeof c)e[a]=c;else if("object"==typeof a)e=a;else return this.log("Wrong parameters passed to on() method"),!1;for(var d in e)e.hasOwnProperty(d)&&(c=e[d],d=d.toLowerCase(),this._events[d]||(this._events[d]=[]),this._events[d].push(c));return this};APS.prototype.getPipe=function(a){return a in this.pipes?this.pipes[a]:!1};APS.prototype.send=function(a,c,e,d,b){this.sendCmd("Event",{event:c,data:e,sync:d},a,b);return this};
...
APS.User=function(a,c){Object.defineProperties(this,{_update:{value:function(a,b){if(!a)return!1;b||(a._rev=parseInt(a._rev));if(a._rev>this._rev||b)for(var e in a)this[e]!=a[e]&&(this[e]=a[e],c.trigger("user"+e+"Update",[a[e],this]),c.trigger("userUpdate",[e,a[e],this]))}},_rev:{value:null,configurable:!0,writable:!0},channels:{value:{},writable:!0},pubid:{value:a.pubid},pub:{value:c.pub.bind(c,a.pubid)},publish:{value:c.pub.bind(c,a.pubid)},send:{value:c.send.bind(c,a.pubid)}});for(var e in a.properties)this[e]=
a.properties[e]};
APS.CUser=function(a,c){Object.defineProperties(this,{_update:{value:function(a,b){if(!a)return!1;b||(a._rev=parseInt(a._rev));if(a._rev>this._rev||b)for(var c in a)this[c]!=a[c]&&(this[c]=a[c],this.trigger("user"+c+"Update",[a[c],this]),this.trigger("userUpdate",[c,a[c],this]))}},update:{value:function(a,b){if("object"==typeof a)var c=a;else c={},c[a]=b;this._update(c,!0);this._client.sendCmd("userPropUpdate",c)}},_rev:{value:null,configurable:!0,writable:!0},_events:{value:{},writable:!0},_client:{value:c},
...
APS.Channel=function(a,c){Object.defineProperties(this,{_update:{value:function(a){if(!a)return!1;a._rev=parseInt(a._rev);if(a._rev>this._rev)for(var b in a)this[b]!=a[b]&&(this[b]=a[b],this.trigger("user"+b+"Update",[a[b],this]),this.trigger("userUpdate",[b,a[b],this]))}},leave:{value:function(){this.trigger("unsub",[c.user,this]);c.sendCmd("LEFT",{channel:a.properties.name});this.log("Unsubscribed");delete c.channels[this.name];delete c.eQueue[this.name]}},_rev:{value:null,configurable:!0,writable:!0},
_events:{value:{},writable:!0},_client:{value:c},pubid:{value:a.pubid},users:{value:{},writable:!0},on:{value:c.on.bind(this)},trigger:{value:c.trigger.bind(this)},log:{value:c.log.bind(c,"[channel]","["+a.properties.name+"]")}});for(var e in a.properties)this[e]=a.properties[e];0!==this.name.indexOf("*")&&Object.defineProperties(this,{users:{value:{},writable:!0},addUser:{value:function(a){var b=c.getPipe(a.pubid);b?c.option.autoUpdate&&b._update(a.properties):(c.pipes[a.pubid]=new APS.User(a,c),
b=c.pipes[a.pubid],b.channels[b.pubid]=b);b.channels[this.name]=this;return this.users[a.pubid]=b}},send:{value:c.send.bind(c,this.pubid)},pub:{value:c.pub.bind(c,this.name)},publish:{value:c.pub.bind(c,this.name)}})};
