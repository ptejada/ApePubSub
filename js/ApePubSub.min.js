...
function APS(c,a,e){this.option={poll:25E3,debug:!1,session:!0,connectionArgs:{},server:c,transport:["ws","lp"],secure:!1,eventPush:!1,addFrequency:!0,autoUpdate:!0};this.identifier="APS";this.version="1.6.3b1";this.state=0;this._events={};this.user={};this.pipes={};this.channels={};this.eQueue={};if(a)this.on(a);if(e)for(var d in e)this.option[d]=e[d];"Microsoft Internet Explorer"==navigator.appName&&(this.log="undefined"==typeof window.console?function(){}:function(){if(!1!=this.option.debug){var b=
