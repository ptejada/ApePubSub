<?php
	...
	switch($c->event){
		case "message":
			...
			/*
			 * You can go as far as overwriting the event name itself
			 */
			//$c->event = "data";
			break;
	}
	 ...
	 * 
	 * Please note that the connection is closed to speed up the push process
	 ...
	 * be affected because they would've already received their response.
	 * 
